...
def get_model_instance_segmentation(num_classes):
    ...
    model.backbone.body.conv1 = nn.Conv2d(9,conv1.out_channels, kernel_size=7, stride=2, padding=3, bias=False)

    model.transform.image_mean = [0.485, 0.456, 0.406, 0.485, 0.456, 0.406, 0.485, 0.456, 0.406]
    model.transform.image_std = [0.229, 0.224, 0.225, 0.229, 0.224, 0.225, 0.229, 0.224, 0.225]
...
def trainPennFudanDataset():
    ...
    print("That's it!")
    torch.save(model.state_dict(), os.path.join(data_root_path, 'pkl/model_state_dict_penn.pth'))
